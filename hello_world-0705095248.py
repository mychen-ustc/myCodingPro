...
args = {
    "project_id": "hello_world-0705095248",
}

dag = DAG(
    "hello_world-0705095248",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.1 pipeline editor using hello_world.pipeline.",
...
notebook_op_dc69c562_0968_4daf_b252_bf988b058537 = NotebookOp(
    ...
    cos_directory="hello_world-0705095248",
